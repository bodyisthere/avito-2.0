...
import { excavatorsBrands } from "./data/excavatorsBrands";

export const generateExcavators = (): IAdsTemplate[] => {
  return ([
    {
    ...
    },
    {
      ...
      fields: [
        ...
        {
          type: "FieldWithInput",
          fieldTitle: "Объём ковша",
          optionKey: "bucketVolume",
          after: "м3",
        },
      ],
    },
