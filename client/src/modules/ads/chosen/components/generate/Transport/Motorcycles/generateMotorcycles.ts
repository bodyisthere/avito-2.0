...
import { motorcyclesBrands, motorcyclesTypes, motorcyclesAdditional } from "./data/motorcyclesBrands";

import { yearGenerate } from "../../../../utils/yearGenerate";

export const generateMotorcycles = (): IAdsTemplate[] => {
  return ([
    {
          ...
          optional: {
            "Бензин": [
              ...
              },
              {
                type: "RadioButtonsChoose",
                data: ["1", "2", "3", "4", "5", "6"],
                fieldTitle: "Количество цилиндров",
                optionKey: "numberOfCylinders",
              },
              {
                type: "RadioButtonsChoose",
              ...
              {
                type: "RadioButtonsChoose",
                data: ["V-образное", "Оппозитное", "Рядное"],
                fieldTitle: "Расположение цилиндров",
                optionKey: "cylinderArrangement",
              },
              {
                type: "RadioButtonsChoose",
