...
import { tractorsBrands } from "./data/tractorsBrands";

import { craneArmBrands } from "./data/trucksBrands";

export const generateTractors = (): IAdsTemplate[] => {
  return ([
    {
    ...
    },
    {
      ...
      fields: [
        ...
        {
          type: "SelectField",
          fieldTitle: "Тип кабины",
          data: ["2-х местная без спального", "2-х местная с 1 спальным", "2-х местная с 2 спальными", "3-х местная без спального", "3-х местная с 1 спальным"],
          optionKey: "cabinType",
        },
        {
          type: "SelectField",
          fieldTitle: "Подвеска кабины",
          data: ["Механическая", "Пневматическая"],
          optionKey: "cabinSuspension",
        },
        {
          type: "SelectField",
        ...
        {
          type: "FieldWithInput",
          fieldTitle: "Высота седельного устройства",
          optionKey: "fifthWheelHeight",
          after: "мм",
        },
      ],
    },
