...
import { bulldozersBrands } from "./data/bulldozersBrands";

export const generateBulldozers = (): IAdsTemplate[] => {
  return ([
    {
    ...
    },
    {
      ...
      fields: [
        ...
        {
          type: "FieldWithInput",
          fieldTitle: "Ширина отвала",
          optionKey: "bladeWidth",
          after: "м",
        },
        {
          type: "SelectField",
          fieldTitle: "Тяговый класс",
          data: ["3", "4", "6", "10", "15", "25", "35", "50", "75"],
